...
export default function GeoJSONMapPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingId) {
        body.id = editingId;
        if (existing) body.geometry = existing.geometry;
      } else {
        // New feature without file import — use empty Point as placeholder
        body.geometry = { type: 'Point', coordinates: [102.77, 14.41] };
      }
  ...
  return (
    <>
      <Head><title>แผนที่ GeoJSON | Smart Lahansai Admin</title></Head>
          ...
          <form onSubmit={handleSave} className="space-y-3">
            <div>
              ...
              <input
                ...
                placeholder="เช่น หมู่ 1 ตำบลละหานทราย"
