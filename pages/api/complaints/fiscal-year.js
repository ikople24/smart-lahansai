...
export default async function handler(req, res) {
  ...
  try {
    ...
    const range = monthRange
      ? clampRange(monthRange.start, monthRange.endExclusive, fyStart, fyEndExclusive)
      : { start: fyStart, endExclusive: fyEndExclusive };
