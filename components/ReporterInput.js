  ...
  return (
    <div className="flex flex-col space-y-2">
      <div className="flex flex-col space-y-2 mt-2">
        ...
        <textarea
          className="textarea w-full bg-pink-50 text-pink-900 border-pink-300 placeholder:text-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-500"
      ...
      <div className="flex flex-col space-y-2 mt-2">
        ...
        <div className="flex gap-2">
          <div className="flex flex-col flex-shrink-0">
            ...
            <select
              className="select select-bordered bg-pink-100 text-pink-900 border-pink-300 w-28 focus:outline-none focus:ring-2 focus:ring-pink-500"
              value={prefix}
              onChange={(e) => setPrefix(e.target.value)}
            >
              <option value="นาย" className="text-pink-700">
                นาย
              </option>
              <option value="นาง" className="text-pink-700">
                นาง
              </option>
              <option value="น.ส." className="text-pink-700">
                น.ส.
              </option>
            </select>
          </div>
          <div className="flex flex-1 flex-col">
            ...
            <input
              type="text"
              className="input input-bordered flex-1 bg-pink-50 text-pink-900 border-pink-300 placeholder:text-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-500"
      ...
      <div className="flex flex-col space-y-2 mt-2">
        ...
        <div className="relative w-full">
          <input
            type="tel"
            className="input input-bordered w-full bg-pink-50 text-pink-900 border-pink-300 placeholder:text-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-500 pl-10 tabular-nums"
          ...
          />
          <svg
            className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-pink-900 pointer-events-none z-10"
